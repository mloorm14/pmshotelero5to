    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      {rooms.map((room) => {
        ...
        return (
          <article
            key={room.id}
            className={`rounded-lg border-2 bg-white p-6 shadow-sm ${styles.card}`}
          >
            ...
            <div className="flex flex-wrap gap-2">
              {isDirty && (
                <button
                  ...
                  className="rounded-md bg-emerald-700 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-white"
                >
                  Marcar como Limpia
                </button>
              )}
              ...
              <button
                ...
                className={`rounded-md px-4 py-2 text-sm font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white ${
                  isMaintenance
            ...
            {room.status === ROOM_STATUSES.OCCUPIED && (
              <p className="mt-3 text-xs text-wine-700">
